            ...
            <div className="vps">
                ...
                <div className="plans">
                    <div className="plan">
                        ...
                        <button
                            onClick={() => navigate('/contratar/vps-standart')}
                        >
                            Contratar
                        </button>
                    </div>
                    ...
                    <div className="plan">
                        ...
                        <button
                            onClick={() => navigate('/contratar/vps-otimized')}
                        >
                            Contratar
                        </button>
                    </div>
                    ...
                    <div className="plan">
                        ...
                        <button
                            onClick={() => navigate('/contratar/vps-platinum')}
                        >
                            Contratar
                        </button>
                    </div>
                    ...
                    <div className="plan">
                        ...
                        <button
                            onClick={() => navigate('/contratar/vps-premium')}
                        >
                            Contratar
                        </button>
                    </div>
