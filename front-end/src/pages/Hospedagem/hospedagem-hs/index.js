            ...
            <div className="hospedagem">
                ...
                <div className="plans">
                    ...
                    <div className="plan">
                        ...
                        <button onClick={() => navigate('/contratar/plano-pequeno')}>Contratar</button>
                    ...
                    <div className="plan">
                        ...
                        <button onClick={() => navigate('/contratar/plano-medio')}>Contratar</button>
                    ...
                    <div className="plan">
                        ...
                        <button onClick={() => navigate('/contratar/plano-grande')}>Contratar</button>
                    ...
                    <div className="plan">
                        ...
                        <button onClick={() => navigate('/contratar/plano-pro')}>Contratar</button>
