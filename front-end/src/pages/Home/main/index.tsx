        ...
        <Main>
            <div className="plans">
                <div className="plan">
                    ...
                    <button onClick={() => navigate('/hospedagem-sites')}>
                        Ver Planos
                    </button>
                </div>
                ...
                <div className="plan">
                    ...
                    <button onClick={() => navigate('/servidores-dedicados')}>
                        Ver Planos
                    </button>
                </div>
            </div>
            ...
            <article id="about-us">
                ...
                <div className="article">
                    <p>
                        ...
                        mattis dui, non pulvinar lorem felis nec erat Lorem
                        ipsum dolor sit amet, consectetur adipiscing elit. Nunc
                        maximus, nulla ut commodo sagittis, sapien dui mattis
                        dui, non pulvinar lorem felis nec erat Lorem ipsum dolor
                        sit amet, consectetur adipiscing elit. Nunc maximus,
                        nulla ut commodo sagittis, sapien dui mattis dui, non
                        pulvinar lorem felis nec erat Lorem ipsum dolor sit
                        amet, consectetur adipiscing elit. Nunc maximus, nulla
                        ut commodo sagittis, sapien dui mattis dui, non pulvinar
                        lorem felis nec erat Lorem ipsum dolor sit amet,
