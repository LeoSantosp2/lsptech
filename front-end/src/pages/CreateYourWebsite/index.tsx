        ...
        <ContainerImg>
            ...
            <Main>
                <div className="about">
                    ...
                    <div className="text">
                        <p>
                            Temos profissionais com experiências em programação
                            (HTML/CSS, JS, Python e SQL) e, em WordPress.
                        </p>
                    </div>
                </div>
                ...
                <div className="Professionals">
                    ...
                    <div className="infos-professionals">
                        <div>
                            ...
                            <p>
                                Profissional com experiência em programação.
                                (HTML/CSS, JS, Python e SQL)
                            </p>
                        </div>
